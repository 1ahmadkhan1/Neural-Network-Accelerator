module neural_net(input logic CLOCK_50, input logic [3:0] KEY, // KEY[3] is async active-low reset
    ...
    dnn_accel_system sys(.clk_clk(CLOCK_50), .clk_reset_reset_n(KEY[3]),
