...
/*
 * Your current uploaded system.h did not show ACC_0_BASE.
 * After regenerating BSP, this should appear.
 *
 * If your generated macro has a different name, change this one line.
 */
#ifndef ACC_0_BASE
#error "ACC_0_BASE is not defined. Regenerate BSP after adding the accelerator, or replace ACC_0_BASE with your accelerator base macro from system.h."
#endif
