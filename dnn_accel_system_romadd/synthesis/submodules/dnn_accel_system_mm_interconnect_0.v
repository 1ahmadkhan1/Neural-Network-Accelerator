...
module dnn_accel_system_mm_interconnect_0 (
		...
		output wire [12:0] onchip_instruc_mem_s1_address,             //           onchip_instruc_mem_s1.address
		output wire        onchip_instruc_mem_s1_write,               //                                .write
		input  wire [31:0] onchip_instruc_mem_s1_readdata,            //                                .readdata
		output wire [31:0] onchip_instruc_mem_s1_writedata,           //                                .writedata
		output wire [3:0]  onchip_instruc_mem_s1_byteenable,          //                                .byteenable
		output wire        onchip_instruc_mem_s1_chipselect,          //                                .chipselect
		output wire        onchip_instruc_mem_s1_clken,               //                                .clken
	...
	wire   [31:0] onchip_instruc_mem_s1_agent_m0_readdata;                                   // onchip_instruc_mem_s1_translator:uav_readdata -> onchip_instruc_mem_s1_agent:m0_readdata
	wire          onchip_instruc_mem_s1_agent_m0_waitrequest;                                // onchip_instruc_mem_s1_translator:uav_waitrequest -> onchip_instruc_mem_s1_agent:m0_waitrequest
	wire          onchip_instruc_mem_s1_agent_m0_debugaccess;                                // onchip_instruc_mem_s1_agent:m0_debugaccess -> onchip_instruc_mem_s1_translator:uav_debugaccess
	wire   [27:0] onchip_instruc_mem_s1_agent_m0_address;                                    // onchip_instruc_mem_s1_agent:m0_address -> onchip_instruc_mem_s1_translator:uav_address
	wire    [3:0] onchip_instruc_mem_s1_agent_m0_byteenable;                                 // onchip_instruc_mem_s1_agent:m0_byteenable -> onchip_instruc_mem_s1_translator:uav_byteenable
	wire          onchip_instruc_mem_s1_agent_m0_read;                                       // onchip_instruc_mem_s1_agent:m0_read -> onchip_instruc_mem_s1_translator:uav_read
	wire          onchip_instruc_mem_s1_agent_m0_readdatavalid;                              // onchip_instruc_mem_s1_translator:uav_readdatavalid -> onchip_instruc_mem_s1_agent:m0_readdatavalid
	wire          onchip_instruc_mem_s1_agent_m0_lock;                                       // onchip_instruc_mem_s1_agent:m0_lock -> onchip_instruc_mem_s1_translator:uav_lock
	wire   [31:0] onchip_instruc_mem_s1_agent_m0_writedata;                                  // onchip_instruc_mem_s1_agent:m0_writedata -> onchip_instruc_mem_s1_translator:uav_writedata
	wire          onchip_instruc_mem_s1_agent_m0_write;                                      // onchip_instruc_mem_s1_agent:m0_write -> onchip_instruc_mem_s1_translator:uav_write
	wire    [2:0] onchip_instruc_mem_s1_agent_m0_burstcount;                                 // onchip_instruc_mem_s1_agent:m0_burstcount -> onchip_instruc_mem_s1_translator:uav_burstcount
	wire          onchip_instruc_mem_s1_agent_rf_source_valid;                               // onchip_instruc_mem_s1_agent:rf_source_valid -> onchip_instruc_mem_s1_agent_rsp_fifo:in_valid
	wire  [104:0] onchip_instruc_mem_s1_agent_rf_source_data;                                // onchip_instruc_mem_s1_agent:rf_source_data -> onchip_instruc_mem_s1_agent_rsp_fifo:in_data
	wire          onchip_instruc_mem_s1_agent_rf_source_ready;                               // onchip_instruc_mem_s1_agent_rsp_fifo:in_ready -> onchip_instruc_mem_s1_agent:rf_source_ready
	wire          onchip_instruc_mem_s1_agent_rf_source_startofpacket;                       // onchip_instruc_mem_s1_agent:rf_source_startofpacket -> onchip_instruc_mem_s1_agent_rsp_fifo:in_startofpacket
	wire          onchip_instruc_mem_s1_agent_rf_source_endofpacket;                         // onchip_instruc_mem_s1_agent:rf_source_endofpacket -> onchip_instruc_mem_s1_agent_rsp_fifo:in_endofpacket
	wire          onchip_instruc_mem_s1_agent_rsp_fifo_out_valid;                            // onchip_instruc_mem_s1_agent_rsp_fifo:out_valid -> onchip_instruc_mem_s1_agent:rf_sink_valid
	wire  [104:0] onchip_instruc_mem_s1_agent_rsp_fifo_out_data;                             // onchip_instruc_mem_s1_agent_rsp_fifo:out_data -> onchip_instruc_mem_s1_agent:rf_sink_data
	wire          onchip_instruc_mem_s1_agent_rsp_fifo_out_ready;                            // onchip_instruc_mem_s1_agent:rf_sink_ready -> onchip_instruc_mem_s1_agent_rsp_fifo:out_ready
	wire          onchip_instruc_mem_s1_agent_rsp_fifo_out_startofpacket;                    // onchip_instruc_mem_s1_agent_rsp_fifo:out_startofpacket -> onchip_instruc_mem_s1_agent:rf_sink_startofpacket
	wire          onchip_instruc_mem_s1_agent_rsp_fifo_out_endofpacket;                      // onchip_instruc_mem_s1_agent_rsp_fifo:out_endofpacket -> onchip_instruc_mem_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_002_src_valid;                                                     // cmd_mux_002:src_valid -> onchip_instruc_mem_s1_agent:cp_valid
	wire  [103:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> onchip_instruc_mem_s1_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                     // onchip_instruc_mem_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [5:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> onchip_instruc_mem_s1_agent:cp_channel
	wire          cmd_mux_002_src_startofpacket;                                             // cmd_mux_002:src_startofpacket -> onchip_instruc_mem_s1_agent:cp_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                               // cmd_mux_002:src_endofpacket -> onchip_instruc_mem_s1_agent:cp_endofpacket
	...
	wire          onchip_instruc_mem_s1_agent_rp_valid;                                      // onchip_instruc_mem_s1_agent:rp_valid -> router_004:sink_valid
	wire  [103:0] onchip_instruc_mem_s1_agent_rp_data;                                       // onchip_instruc_mem_s1_agent:rp_data -> router_004:sink_data
	wire          onchip_instruc_mem_s1_agent_rp_ready;                                      // router_004:sink_ready -> onchip_instruc_mem_s1_agent:rp_ready
	wire          onchip_instruc_mem_s1_agent_rp_startofpacket;                              // onchip_instruc_mem_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          onchip_instruc_mem_s1_agent_rp_endofpacket;                                // onchip_instruc_mem_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire   [85:0] onchip_memory2_0_s1_agent_rp_data;                                         // onchip_memory2_0_s1_agent:rp_data -> router_007:sink_data
	...
	wire   [85:0] onchip_memory2_0_s1_burst_adapter_source0_data;                            // onchip_memory2_0_s1_burst_adapter:source0_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire   [85:0] router_007_src_data;                                                       // router_007:src_data -> onchip_memory2_0_s1_rsp_width_adapter:in_data
	...
	wire  [103:0] onchip_memory2_0_s1_rsp_width_adapter_src_data;                            // onchip_memory2_0_s1_rsp_width_adapter:out_data -> rsp_demux_005:sink_data
	...
	wire  [103:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> onchip_memory2_0_s1_cmd_width_adapter:in_data
	...
	wire   [85:0] onchip_memory2_0_s1_cmd_width_adapter_src_data;                            // onchip_memory2_0_s1_cmd_width_adapter:out_data -> onchip_memory2_0_s1_burst_adapter:sink0_data
	...
	wire          onchip_instruc_mem_s1_agent_rdata_fifo_src_valid;                          // onchip_instruc_mem_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] onchip_instruc_mem_s1_agent_rdata_fifo_src_data;                           // onchip_instruc_mem_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire          onchip_instruc_mem_s1_agent_rdata_fifo_src_ready;                          // avalon_st_adapter_002:in_0_ready -> onchip_instruc_mem_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_002_out_0_valid;                                         // avalon_st_adapter_002:out_0_valid -> onchip_instruc_mem_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                                          // avalon_st_adapter_002:out_0_data -> onchip_instruc_mem_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                                         // onchip_instruc_mem_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                                         // avalon_st_adapter_002:out_0_error -> onchip_instruc_mem_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) onchip_instruc_mem_s1_translator (
		.clk                    (pll_0_outclk0_clk),                            //                      clk.clk
		.reset                  (CPU_reset_reset_bridge_in_reset_reset),        //                    reset.reset
		.uav_address            (onchip_instruc_mem_s1_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (onchip_instruc_mem_s1_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (onchip_instruc_mem_s1_agent_m0_read),          //                         .read
		.uav_write              (onchip_instruc_mem_s1_agent_m0_write),         //                         .write
		.uav_waitrequest        (onchip_instruc_mem_s1_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (onchip_instruc_mem_s1_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (onchip_instruc_mem_s1_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (onchip_instruc_mem_s1_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (onchip_instruc_mem_s1_agent_m0_writedata),     //                         .writedata
		.uav_lock               (onchip_instruc_mem_s1_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (onchip_instruc_mem_s1_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (onchip_instruc_mem_s1_address),                //      avalon_anti_slave_0.address
		.av_write               (onchip_instruc_mem_s1_write),                  //                         .write
		.av_readdata            (onchip_instruc_mem_s1_readdata),               //                         .readdata
		.av_writedata           (onchip_instruc_mem_s1_writedata),              //                         .writedata
		.av_byteenable          (onchip_instruc_mem_s1_byteenable),             //                         .byteenable
		.av_chipselect          (onchip_instruc_mem_s1_chipselect),             //                         .chipselect
		.av_clken               (onchip_instruc_mem_s1_clken),                  //                         .clken
		.av_read                (),                                             //              (terminated)
		.av_begintransfer       (),                                             //              (terminated)
		.av_beginbursttransfer  (),                                             //              (terminated)
		.av_burstcount          (),                                             //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) onchip_instruc_mem_s1_agent (
		.clk                     (pll_0_outclk0_clk),                                      //             clk.clk
		.reset                   (CPU_reset_reset_bridge_in_reset_reset),                  //       clk_reset.reset
		.m0_address              (onchip_instruc_mem_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (onchip_instruc_mem_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (onchip_instruc_mem_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (onchip_instruc_mem_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (onchip_instruc_mem_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (onchip_instruc_mem_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (onchip_instruc_mem_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (onchip_instruc_mem_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (onchip_instruc_mem_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (onchip_instruc_mem_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (onchip_instruc_mem_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (onchip_instruc_mem_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (onchip_instruc_mem_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (onchip_instruc_mem_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (onchip_instruc_mem_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (onchip_instruc_mem_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (onchip_instruc_mem_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (onchip_instruc_mem_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (onchip_instruc_mem_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (onchip_instruc_mem_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (onchip_instruc_mem_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (onchip_instruc_mem_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (onchip_instruc_mem_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (onchip_instruc_mem_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (onchip_instruc_mem_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (onchip_instruc_mem_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_002_out_0_ready),                      // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_002_out_0_valid),                      //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_002_out_0_data),                       //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_002_out_0_error),                      //                .error
		.rdata_fifo_src_ready    (onchip_instruc_mem_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (onchip_instruc_mem_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (onchip_instruc_mem_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                                  //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                    //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) onchip_instruc_mem_s1_agent_rsp_fifo (
		.clk               (pll_0_outclk0_clk),                                      //       clk.clk
		.reset             (CPU_reset_reset_bridge_in_reset_reset),                  // clk_reset.reset
		.in_data           (onchip_instruc_mem_s1_agent_rf_source_data),             //        in.data
		.in_valid          (onchip_instruc_mem_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (onchip_instruc_mem_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (onchip_instruc_mem_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (onchip_instruc_mem_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (onchip_instruc_mem_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (onchip_instruc_mem_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (onchip_instruc_mem_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (onchip_instruc_mem_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (onchip_instruc_mem_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                  // (terminated)
		.csr_read          (1'b0),                                                   // (terminated)
		.csr_write         (1'b0),                                                   // (terminated)
		.csr_readdata      (),                                                       // (terminated)
	...
	dnn_accel_system_mm_interconnect_0_router_002 router_004 (
		.sink_ready         (onchip_instruc_mem_s1_agent_rp_ready),         //      sink.ready
		.sink_valid         (onchip_instruc_mem_s1_agent_rp_valid),         //          .valid
		.sink_data          (onchip_instruc_mem_s1_agent_rp_data),          //          .data
		.sink_startofpacket (onchip_instruc_mem_s1_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (onchip_instruc_mem_s1_agent_rp_endofpacket),   //          .endofpacket
		.clk                (pll_0_outclk0_clk),                            //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset),        // clk_reset.reset
	...
	dnn_accel_system_mm_interconnect_0_rsp_demux_004 rsp_demux_004 (
		.clk                (pll_0_outclk0_clk),                                       //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset),                   // clk_reset.reset
	...
	dnn_accel_system_mm_interconnect_0_rsp_demux_004 rsp_demux_005 (
		.clk                (pll_0_outclk0_clk),                                       //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset),                   // clk_reset.reset
	...
	dnn_accel_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (pll_0_outclk0_clk),                                // in_clk_0.clk
		.in_rst_0_reset (CPU_reset_reset_bridge_in_reset_reset),            // in_rst_0.reset
		.in_0_data      (onchip_instruc_mem_s1_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (onchip_instruc_mem_s1_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (onchip_instruc_mem_s1_agent_rdata_fifo_src_ready), //         .ready
