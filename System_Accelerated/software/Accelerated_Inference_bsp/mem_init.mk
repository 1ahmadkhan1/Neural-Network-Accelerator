...
$(MEM_0)_START := 0x00010080
$(MEM_0)_END := 0x0001009f
$(MEM_0)_SPAN := 0x00000020
$(MEM_0)_HIERARCHICAL_PATH := b1
$(MEM_0)_WIDTH := 16
...
.PHONY: b1
b1: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
...
$(MEM_1)_START := 0x00010060
$(MEM_1)_END := 0x0001007f
$(MEM_1)_SPAN := 0x00000020
$(MEM_1)_HIERARCHICAL_PATH := b2
$(MEM_1)_WIDTH := 16
...
.PHONY: b2
b2: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
...
$(MEM_2)_START := 0x00010040
$(MEM_2)_END := 0x0001005f
$(MEM_2)_SPAN := 0x00000020
$(MEM_2)_HIERARCHICAL_PATH := b3
$(MEM_2)_WIDTH := 16
...
.PHONY: b3
b3: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym

# Memory: input_layer
MEM_3 := test_image
$(MEM_3)_NAME := input_layer
...
$(MEM_3)_START := 0x00011000
$(MEM_3)_END := 0x0001161f
$(MEM_3)_SPAN := 0x00000620
$(MEM_3)_HIERARCHICAL_PATH := input_layer
$(MEM_3)_WIDTH := 16
...
.PHONY: input_layer
input_layer: check_elf_exists $(MEM_INIT_DIR)/$(MEM_3).hex $(HDL_SIM_DIR)/$(MEM_3).dat $(HDL_SIM_DIR)/$(MEM_3).sym

# Memory: onchip_memory
MEM_4 := basics_onchip_memory
...
$(MEM_4)_END := 0x0000ffff
$(MEM_4)_SPAN := 0x00010000
...
$(MEM_5)_START := 0x00018000
$(MEM_5)_END := 0x0001e1ff
$(MEM_5)_SPAN := 0x00006200
$(MEM_5)_HIERARCHICAL_PATH := w1
$(MEM_5)_WIDTH := 16
...
.PHONY: w1
w1: check_elf_exists $(MEM_INIT_DIR)/$(MEM_5).hex $(HDL_SIM_DIR)/$(MEM_5).dat $(HDL_SIM_DIR)/$(MEM_5).sym
...
$(MEM_6)_START := 0x00010200
$(MEM_6)_END := 0x000103ff
$(MEM_6)_SPAN := 0x00000200
$(MEM_6)_HIERARCHICAL_PATH := w2
$(MEM_6)_WIDTH := 16
...
.PHONY: w2
w2: check_elf_exists $(MEM_INIT_DIR)/$(MEM_6).hex $(HDL_SIM_DIR)/$(MEM_6).dat $(HDL_SIM_DIR)/$(MEM_6).sym
...
$(MEM_7)_START := 0x00010400
$(MEM_7)_END := 0x0001053f
$(MEM_7)_SPAN := 0x00000140
$(MEM_7)_HIERARCHICAL_PATH := w3
$(MEM_7)_WIDTH := 16
$(MEM_7)_HEX_DATA_WIDTH := 16
$(MEM_7)_ENDIANNESS := --little-endian-mem
$(MEM_7)_CREATE_LANES := 0

.PHONY: w3
w3: check_elf_exists $(MEM_INIT_DIR)/$(MEM_7).hex $(HDL_SIM_DIR)/$(MEM_7).dat $(HDL_SIM_DIR)/$(MEM_7).sym
